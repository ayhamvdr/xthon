                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @AA37A\
                                  \n\n--------بـدء تتبـع سجـل ميكسثونMixthon--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع ميكسثونMixthon--------"
                        ...
                        link = "[𐇮Abdullah 𐇮](https://t.me/AA37A)"
                        text = (
                            "**✘ تقـريـر اشعـار ميكسثونMixthon ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار ميكسثونMixthon ✘**\n\n "
                        link = "[𐇮Abdullah 𐇮](https://t.me/AA37A)"
